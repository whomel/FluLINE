...
def cmdline_parser():
    ...
    parser.add_option("-g", "--fastq_file2",
                      dest="f2",
                      help="Fastq file2 name eg) IonExpress001-Qc.fastq")    
...
# Read the summary file:
  ...
  for x in SeqIO.parse(open(ref, "r"), "fasta"):
    ...
    cons_cmd = "bam2cons_iter-lenient.sh  -f " + opts.f1 + " -g " + opts.f2 + " -r " + split_ref + " -t " + threads + " --force -o " + cons_ref    
    print cons_cmd
    ...
    # IonXpress_012-Qc.fastq
      ...
      cons_cmd2 = "bam2cons_iter-lenient.sh -f " + opts.f1 + " -g " + opts.f2 + " -r " + nearest_ref1 + " -t " + threads + " --force -o " + cons_ref2    
      print cons_cmd2
  ...
  if flag == 1:
    ...
    bowtie2_cmd = "bowtie2 --local  -x  tmp_idx  -1 " + opts.f1 + " -2 " + opts.f2 + " -S  " + out_sam + " -p 8"
